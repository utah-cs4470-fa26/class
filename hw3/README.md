...
[jpl-p]: https://github.com/utah-cs4470-fa26/class/blob/main/spec.md#jpl-compiler-command-line-interface
...
We will call your compiler's `Makefile` with two
...
repository](https://github.com/utah-cs4470-fa26/grader/tree/main/hw3).
...
## Comparing to the Staff Reference Compiler

The JPL compiler in the "[Releases][releases]" supports the `-p`
